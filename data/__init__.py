...
def create_dataloader(dataset,
    ...
    if phase == 'train':
        ...
        TrainLoader = DataLoader(dataset, 
            batch_size=dataset_opt["batch_size"], num_workers=dataset_opt["num_workers"],
            drop_last=True, pin_memory=dataset_opt["pin_memory"], persistent_workers = dataset_opt["persistent_workers"],
            collate_fn = collate_fn, sampler=sampler, prefetch_factor = 2)
        ...
        TestLoader = DataLoader(dataset,
                batch_size=dataset_opt["batch_size"], num_workers=dataset_opt["num_workers"],
                drop_last=False, pin_memory= dataset_opt["pin_memory"],persistent_workers = dataset_opt["persistent_workers"],
                collate_fn = collate_fn, sampler=sampler, prefetch_factor = 2)
